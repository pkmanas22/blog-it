...
class UserTest < ActiveSupport::TestCase
  ...
  def test_name_should_not_be_blank_or_white_space
    @user.name = "          "
    assert @user.invalid?
  end
  ...
  def test_email_should_be_of_valid_length
  ...
  def test_organization_id_is_present_or_not
